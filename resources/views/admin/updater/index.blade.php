...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.updater') }}" enctype="multipart/form-data" method="POST" class="box">
            ...
            @if($canRestore)
                <form action="{{ route('admin.updater.restore') }}" method="post" class="box box-danger">
                    <div class="box-header">
            ...
            @endif
            <p class="text-muted">Copyright &copy; {{ date('Y') }} <a href="https://itsvic.dev">it's vic!</a> All Rights Reserved.</p>
        </div>
    </div>
