<style>
  ...
  <?php elseif($n_animations == "zoomout"): ?>
    @keyframes nebula-animation {
      0% { opacity: 0; scale: 1.1 }
      100% { opacity: 1; scale: 1 }
    }
  <?php elseif($n_animations == "fadein"): ?>
    @keyframes nebula-animation {
      0% { opacity: 0; }
      100% { opacity: 1; }
    }
  <?php elseif($n_animations == "disabled"): ?>
    @keyframes nebula-animation {}
...
</style><?php /**PATH /var/www/pterodactyl/resources/views/blueprint/extensions/nebula/wrapper/animations.blade.php ENDPATH**/ ?>