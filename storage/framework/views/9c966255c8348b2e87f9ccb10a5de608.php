<?php if(Auth::check()): ?>
<script>
  document.querySelector("head > meta[name='theme-color'][content='#0e4688']").setAttribute("content", "<?php echo e($n_palette_dashboard_7); ?>")
</script>
<?php endif; ?>
...
<style id="nebula-theme">
  ...
  <?php if($n_background_image == ""): ?> div.App___StyledDiv-sc-2l91w7-0.fnfeQw { background-color: var(--pageBackground) }
  <?php else: ?> div.App___StyledDiv-sc-2l91w7-0.fnfeQw { background-color: #00000000 } <?php endif; ?>
  div.SubNavigation-sc-lfuaoi-0.jZPsWO { display: none; background-color: var(--pageBackground); opacity: 0; transition: none; }
  ...
  <?php if($n_statusgradient_style == "flat"): ?>
...
<?php /**PATH /var/www/pterodactyl/resources/views/blueprint/extensions/nebula/wrapper/theme/panel.blade.php ENDPATH**/ ?>