...
?>
  ...
  <div id="keybindsContainer" class="keybinds-container">
    <div class="keybinds-content-box">
      <div class="keybinds-content">
        ...
        <?php echo $__env->make('blueprint.extensions.nebula.wrapper.keybinds.binds', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('blueprint.extensions.nebula.wrapper.keybinds.keys', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <div id="keybindsHideAlert" class="keybinds-close-alert">
    <p>Use <code style="background-color: var(--pageSecondaryHover); padding: 5px 10px; border-radius: 5px;"><?php echo $KEY_CTRL; ?> <?php echo $KEY_SLASH; ?></code> to show these keybinds again.</p>
  </div><?php /**PATH /var/www/pterodactyl/resources/views/blueprint/extensions/nebula/wrapper/keybinds/index.blade.php ENDPATH**/ ?>