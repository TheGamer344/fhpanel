                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="pDockerImages" name="docker_images" class="form-control" rows="4"><?php echo e(implode(PHP_EOL, $images)); ?></textarea>
                            ...
                            <div class="form-group">
                                <div class="checkbox checkbox-primary no-margin-bottom">
                                    <input id="pForceOutgoingIp" name="force_outgoing_ip" type="checkbox" value="1" <?php if($egg->force_outgoing_ip): ?> checked <?php endif; ?> />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pterodactyl/resources/views/admin/eggs/view.blade.php ENDPATH**/ ?>