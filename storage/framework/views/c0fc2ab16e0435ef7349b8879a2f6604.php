...
<script>
  ...
  function sidebarButtonEvent(btn) {
    ...
    <?php if(Auth::user()->root_admin == 1): ?> if(btn === "logout") { document.querySelector(".NavigationBar__RightNavigation-sc-tupl2x-0 > button:nth-child(5)").click() };
    <?php else: ?> if(btn === "logout") { document.querySelector(".NavigationBar__RightNavigation-sc-tupl2x-0 > button:nth-child(4)").click() }; <?php endif; ?>
    // servers
  ...
  async function sidebarRefresh() {
    ...
    <?php if($n_sidebar_always_visible_buttons == "0"): ?>
...
</script><?php /**PATH /var/www/pterodactyl/resources/views/blueprint/extensions/nebula/wrapper/script.blade.php ENDPATH**/ ?>